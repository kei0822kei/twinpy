...
def get_twin_indices(twinmode:str,
    ...
    def _twin_indices_orig(lattice, twinmode, wyckoff):
        ...
        K1_1 = HexagonalPlane(lattice=lattice.lattice,
                              four=dataset[twinmode]['K1'])
        K1_2 = HexagonalPlane(lattice=lattice.lattice,
        ...
        indices = {
                     'S'    :     HexagonalPlane(lattice.lattice, four=data['S']),
                     'K1'   :     HexagonalPlane(lattice.lattice, four=data['K1']),
                     'K2'   :     HexagonalPlane(lattice.lattice, four=data['K2']),
                     'eta1' : HexagonalDirection(lattice.lattice, four=data['eta1']),
                     'eta2' : HexagonalDirection(lattice.lattice, four=data['eta2']),
                  }
    ...
    def _set_K1(lattice, indices, wyckoff):
        ...
        candidate_plane = HexagonalPlane(lattice=lattice.lattice,
    ...
    def _set_shear_plane(lattice, indices):
        ...
        for trial_S_four in trial_S_fours:
            trial_S = HexagonalPlane(lattice.lattice, four=trial_S_four)
